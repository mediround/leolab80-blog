...
지난 글에서 떠난 뒤에 남았으면 하는 다섯 가지를 늘어놓으면서, 나는 그중 하나에 이렇게 적었다. "열 번째 시도는 첫 번째 시도보다 훨씬 정확해야 한다. 그게 안 되고 있다면, 배움이 어딘가로 새고 있다는 뜻이다."

오늘은 그 한 줄만 붙잡고 늘어지려 한다. 다섯 가지 중 **이해, 그러니까 데이터.** 앞 글에서 나는 '고객 소유권'을 이야기하며 "실패조차 자산이 된다"는 대목을 다음에 따로 파겠다고 했는데, 그 다음이 바로 이 글이다.
...
늘 그렇듯 솔직히 붙인다. 나 역시 이 기록을 완벽히 하고 있지 않다. 어떤 시도는 여전히 느낌만 남기고 지나가고, 나중에 "그때 뭐가 됐더라" 하며 아쉬워한다. 바쁠 때 가장 먼저 건너뛰는 게 이 기록이라는 것도 안다. 이 글을 쓰는 것도, 그렇게 새어나가던 배움을 붙들어 두려는 시도의 일부다.

그래도 방향만은 분명하다. 유치를 잘하게 되는 길은 매번 더 세게 시도하는 데 있지 않고, **한 번의 시도에서 배운 걸 다음 시도가 딛고 설 수 있게 남기는 데** 있다는 것. 열 번째가 첫 번째보다 정확해지는 순간부터, 비로소 복리가 붙기 시작한다. 그전까지는 아무리 열심히 해도 제자리걸음이다.

혹시 "매번 비슷한 걸 처음부터 다시 하는 것 같다"는 감각 앞에 선 병원·파트너가 있다면, "무엇이 됐고 무엇이 조용했는지"를 같이 한 장에 정리해보고 싶다. 거기서부터가 진짜 시작이라고 믿는다.
